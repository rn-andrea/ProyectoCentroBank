...
namespace CentroBank.Formularios
{
    public partial class Calculadora : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txttaza1.Text = Convert.ToString(cal.GetTasaP1());
        ...
        protected void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Convert.ToInt32(txtmonto1.Text) >= 250000 && Convert.ToInt32(txtmonto1.Text) <= 15000000)
                {
                    if (Convert.ToInt32(txtplazo1.Text) >= 6 && Convert.ToInt32(txtplazo1.Text) <= 240)
