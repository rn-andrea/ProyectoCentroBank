<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalLeasingFinanciero.aspx.cs" Inherits="CentroBank.Formularios.CalLeasingFinanciero" %>
...
<body>
    <form id="form1" runat="server">
        <h2>Calculadora Leasing Financiero</h2>
            <label>Moneda</label>
