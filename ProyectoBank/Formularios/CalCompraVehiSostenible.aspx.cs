...
{
    public partial class CalCompraVehiSostenible : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            NCalculadora cal = new NCalculadora();
            txttaza1.Text = Convert.ToString(cal.GetTasaP6());
            lblmensaje1.Text = "";
        }
        ...
        protected void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            if (chbColones1.Checked = true && txtmonto1.Text != "" && txtplazo1.Text != "")
            {
                ...
                {
                    if (Convert.ToInt32(txtplazo1.Text) >= 6 && Convert.ToInt32(txtplazo1.Text) <= 96)
