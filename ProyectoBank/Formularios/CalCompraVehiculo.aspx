<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalCompraVehiculo.aspx.cs" Inherits="CentroBank.Formularios.CompraVehiculo" %>
...
<body>
    <form id="form1" runat="server">
        <h2>Calculadora Compra de Vehículo</h2>
            <label>Moneda</label>
