<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalTranladoHipoteca.aspx.cs" Inherits="CentroBank.Formularios.CalTranladoHipoteca" %>
...
<body>
    <form id="form1" runat="server">
          <h2>Calculadora Translado de Hipoteca</h2>
            <label>Moneda</label>
        ...
        <p>Monto mínimo 5 000 000- Monto máximo 100 000 000</p>
            <br />
             <label>Plazo</label>
