<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalPrestamoMultiproposito.aspx.cs" Inherits="CentroBank.Formularios.PrestamoMultiproposito" %>
...
<body>
    <form id="form1" runat="server">
        <h2>Calculadora Préstamo Multipropósito</h2>
            <label>Moneda</label>
        ...
        <p>Monto mínimo 1 000 000- Monto máximo 40 000 000</p>
            <br />
             <label>Plazo</label>
            <asp:TextBox ID="txtplazo1" runat="server" type="number" min="6" max="360" pattern="[0-9]+"  required="true"></asp:TextBox>
        <p>Plazo mínimo 6 meses- Plazo máximo 360 meses</p>
            <br />
             <label>Taza</label>
