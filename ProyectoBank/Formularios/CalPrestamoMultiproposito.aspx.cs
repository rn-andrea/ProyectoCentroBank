...
{
    public partial class PrestamoMultiproposito : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            NCalculadora cal = new NCalculadora();
            txttaza1.Text = Convert.ToString(cal.GetTasaP4());
            lblmensaje1.Text = "";
        }
        ...
        protected void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Convert.ToInt32(txtmonto1.Text) >= 1000000 && Convert.ToInt32(txtmonto1.Text) <= 40000000)
                {
                    if (Convert.ToInt32(txtplazo1.Text) >= 6 && Convert.ToInt32(txtplazo1.Text) <= 360)
